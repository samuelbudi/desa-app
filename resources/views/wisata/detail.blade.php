...
@section('title', 'Detail Wisata | Sitolu Huta')

@section('content')
<div class="container mx-auto my-10">
    <div class="mb-4 border-b-4 border-black flex justify-between">
        <h1 class="text-3xl font-bold">{{ $wisata->nama }}</h1>
        <div class="mb-1">
            <a href="/wisata/{{ $wisata->id }}/edit" type="button" class="mx-2 p-2 bg-red-900 text-white px-4 py-2 rounded-lg hover:bg-red-800 mb-4">Edit</a>
